...
export class ComponentDetailPage {
  ...
  protected readonly componentWorkspaces = computed(() => this.workspaces.forComponent(this.componentId));
  protected readonly storybookUrl = storybookUrl;
  protected readonly embedUrl = computed(() => {
    const component = this.component();
    return component ? this.sanitizer.bypassSecurityTrustResourceUrl(storybookEmbedUrl(component)) : null;
  });
